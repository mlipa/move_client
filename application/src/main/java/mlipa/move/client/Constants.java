...
public class Constants {
    ...
    public static final Integer ACTIVITY_NOT_DETECTED_ID = 5;
    ...
    public static final Double DEFAULT_WINDOW_LENGTH = 2.56;
    public static final Double WINDOW_LENGTH_MIN = 1.0;
    public static final Double WINDOW_LENGTH_MAX = 5.0;

    public static final String DEFAULT_CLASSIFIER_ID = "1";

    public static final Integer DEFAULT_INPUT_NEURONS = 3;
    public static final Integer INPUT_NEURONS_MIN = 1;
    public static final Integer INPUT_NEURONS_MAX = 36;

    public static final Integer DEFAULT_HIDDEN_LAYERS = 1;
    public static final Integer HIDDEN_LAYERS_MIN = 1;
    public static final Integer HIDDEN_LAYER_MAX = 5;

    public static final Integer DEFAULT_HIDDEN_NEURONS = 3;
    public static final Integer HIDDEN_NEURONS_MIN = 1;
    public static final Integer HIDDEN_NEURONS_MAX = 36;

    public static final Integer OUTPUT_NEURONS = 4;

    public static final Integer DEFAULT_INPUT_DIVISOR = 10;
    public static final Integer INPUT_DIVISOR_MIN = 10;
    public static final Integer INPUT_DIVISOR_MAX = 1000;

    public static final Double DEFAULT_LEARNING_CONSTANT = 0.6;
    public static final Double LEARNING_CONSTANT_MIN = 0.0;
    public static final Double LEARNING_CONSTANT_MAX = 1.0;

    public static final Integer DEFAULT_LEARNING_ITERATIONS = 10000;
    public static final Integer LEARNING_ITERATIONS_MIN = 1000;
